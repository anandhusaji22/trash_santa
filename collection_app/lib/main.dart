...
import 'package:ktu_pro/forgotpass/forgotpass.dart';
import 'package:ktu_pro/logincheck/privider.dart';
import 'package:ktu_pro/signup/otp/lastsighup.dart';
import 'package:ktu_pro/user_home/user_homepage.dart';
...
class _LoginPageState extends State<LoginPage> {
  ...
  void initState() {
    super.initState();
    _emailController.text = '+91'; // Set your desired country code
  }
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              SizedBox(height: 120,),
              Image.asset(
                'assets/icons/layer.png', // Path to your logo image asset
              ...
              TextFormField(
                ...
                decoration: const InputDecoration(
                  ...
                  hintText: 'Enter the 10 digit number including +91',
                  hintStyle:

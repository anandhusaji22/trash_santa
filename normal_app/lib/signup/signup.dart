...
class SignUpPage extends StatefulWidget {
  ...
  SignUpPage({required this.email5, required this.password,required this.location,required this.id5});
...
void Afterotp(
    ...
    String email5) async {
String data='{ "id": "$id", "ph":"$email5","area": "$area ", "city": "$city ", "email": "$email", "fullname": "$fullName", "house_no": "$houseNumber", "pin_no": "$pin","password":"$password","location":"$selectedlocation"}';

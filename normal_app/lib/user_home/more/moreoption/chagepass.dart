...
class Forgot1 extends StatefulWidget {
  @override
  Forgot1State createState() => Forgot1State();
}

class Forgot1State extends State<Forgot1> {
              ...
              if (!isOtpVerified)
                TextFormField(
                  ...
                  decoration: const InputDecoration(
                    ...
                    hintText: 'enter the 5 digit number include ',
                  ...
                  validator: (value) {
                    ...
                    if (value.length != 5) {
                      return 'id number should be  digits long';
                    }
                    ...
                    ElevatedButton(
                      onPressed: () {
                        if (passwordController.text ==
                          ...
                          Afterotp('set password', emailOrPhoneController.text,
